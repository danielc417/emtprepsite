...
const chapter14Questions = [
  ...
  },
  {
    ...
    options: ["Patient with mild sore throat and normal mentation", "Patient with new altered mental status and no reliable history", "Patient with stable rash and normal work of breathing", "Patient requesting evaluation with normal perfusion"],
    answer: "Patient with new altered mental status and no reliable history",
  ...
  },
  {
    ...
    options: ["Distance is never part of destination choice", "Some patients need specialty resources", "EMTs should bypass hospitals based only on convenience", "Closest hospitals cannot receive unstable patients"],
  ...
  },
  {
    ...
    options: ["Any disease that can spread between hosts", "A disease caused by harmful organisms", "An inflammatory condition without pathogen involvement", "A physiologic response limited to one organ system"],
  ...
  },
  {
    ...
    options: ["Occurs after pathogen invasion but cannot transmit", "Spreads from one person/species to another", "Requires blood exposure in every case", "Produces symptoms only in immunocompromised patients"],
  ...
  },
  {
    ...
    options: ["Disease spread across multiple continents", "Higher than expected disease spread in a population", "Expected baseline disease presence in a region", "Single-source exposure without community spread"],
  ...
  },
  {
    ...
    options: ["Outbreak limited to one facility", "Global spread of disease", "Expected seasonal occurrence", "Noninfectious illness cluster"],
  ...
  },
  {
    ...
    options: ["Hepatitis", "Tuberculosis", "Meningitis", "Influenza"],
    answer: "Hepatitis",
  ...
  },
  {
    ...
    options: ["Nearest clinic with basic evaluation", "Stroke center", "Urgent care with outpatient imaging referral", "Primary care office with same-day appointment"],
  ...
  },
  {
    ...
    options: ["Because every patient may pose exposure risk", "Because only febrile patients transmit infection", "Because PPE replaces the primary assessment", "Because traumatic injuries are the main source of infection"],
...
const additionalAdvancedChapterQuestions = [
  { question: "A febrile patient with cough denies travel but lives with two people recently diagnosed with tuberculosis. Which term best frames the EMS concern?", options: ["Communicable disease exposure", "Noninfectious inflammatory illness", "Traumatic mechanism of injury", "Endocrine emergency"], answer: "Communicable disease exposure", explanation: "TB exposure with respiratory symptoms raises concern for a disease that can spread between hosts.", category: "Medical Terminology", chapter: 14 },
  { question: "Which phrase best defines nature of illness in a medical call?", options: ["The suspected medical reason EMS was requested", "The exact hospital diagnosis before transport", "The force pattern that caused tissue injury", "The receiving facility chosen by dispatch"], answer: "The suspected medical reason EMS was requested", explanation: "NOI is the general medical problem inferred from dispatch, scene clues, symptoms, and history.", category: "Nature of Illness / Patient Assessment", chapter: 14 },
  { question: "Which situation best illustrates a medical emergency producing a trauma patient?", options: ["Syncope while standing followed by a fall with head impact", "Forearm laceration from broken glass with no preceding symptoms", "Ankle sprain after stepping off a curb", "Burn from touching a hot pan"], answer: "Syncope while standing followed by a fall with head impact", explanation: "A medical event can cause secondary trauma, requiring assessment for both.", category: "Medical vs Trauma", chapter: 14 },
  { question: "An outbreak is above expected levels in one county but has not crossed international borders. Which term is most precise?", options: ["Epidemic", "Pandemic", "Endemic", "Sporadic exposure"], answer: "Epidemic", explanation: "An epidemic exceeds expected occurrence in a defined population or region.", category: "Epidemic and Pandemic", chapter: 14 },
  { question: "Which presentation best fits an immunologic emergency category rather than neurologic, endocrine, or hematologic?", options: ["Wheezing and hypotension after a known allergen", "Aphasia with unilateral arm drift", "Confusion after insulin without food", "Joint swelling in hemophilia"], answer: "Wheezing and hypotension after a known allergen", explanation: "Allergic and anaphylactic reactions are immunologic emergencies.", category: "Medical Terminology", chapter: 14 },
  { question: "When choosing destination for a medical patient, which factor should outweigh simple distance?", options: ["Need for a time-sensitive specialty center", "Whether the hospital is easiest to find", "Whether the patient has mild symptoms only", "Whether transport time can be estimated exactly"], answer: "Need for a time-sensitive specialty center", explanation: "Stroke, STEMI, trauma, and other specialty needs may justify bypassing the closest facility according to protocol.", category: "Management, Transport, and Destination", chapter: 14 },

  { question: "What does aphasia mean in a neurologic assessment?", options: ["Impaired language production or comprehension", "Loss of coordinated balance", "Painful swallowing", "Brief fainting with rapid recovery"], answer: "Impaired language production or comprehension", explanation: "Aphasia is a language disorder, not just slurred articulation.", category: "Medical Terminology", chapter: 17 },
  { question: "Which term describes slurred articulation with otherwise appropriate language content?", options: ["Dysarthria", "Aphasia", "Ataxia", "Neglect"], answer: "Dysarthria", explanation: "Dysarthria is a motor speech problem; aphasia is impaired language production or understanding.", category: "Medical Terminology", chapter: 17 },
  { question: "A patient ignores the left arm and denies weakness, but follows commands with the right arm. Which term best describes this finding?", options: ["Neglect", "Ataxia", "Aura", "Syncope"], answer: "Neglect", explanation: "Neglect is poor awareness of one side of the body or visual field.", category: "Stroke Presentation", chapter: 17 },
  { question: "Which description best defines status epilepticus for EMT decision-making?", options: ["Prolonged or recurrent seizures without return to baseline consciousness", "Brief staring spell with immediate full recovery", "Fainting episode after standing with no postictal phase", "Single focal tremor with preserved awareness and no progression"], answer: "Prolonged or recurrent seizures without return to baseline consciousness", explanation: "Status epilepticus is life-threatening because airway, ventilation, and metabolic demand may deteriorate.", category: "Status Epilepticus", chapter: 17 },
  { question: "Which finding makes hypoglycemia a dangerous stroke mimic?", options: ["Altered mental status with possible focal weakness", "Normal mentation with isolated ankle pain", "Gradual rash after allergen exposure", "Localized flank pain radiating to the groin"], answer: "Altered mental status with possible focal weakness", explanation: "Low glucose can impair brain function and produce findings that resemble stroke.", category: "Stroke Mimics", chapter: 17 },
  { question: "Which term means a warning sensation before some seizures?", options: ["Aura", "Postictal state", "Dysarthria", "Hemiparesis"], answer: "Aura", explanation: "An aura may include unusual sensory symptoms before seizure activity.", category: "Medical Terminology", chapter: 17 },

  { question: "What does melena mean?", options: ["Black, tarry stool from digested blood", "Bright red vomited blood", "Pain with urination", "Diffuse peritoneal inflammation"], answer: "Black, tarry stool from digested blood", explanation: "Melena suggests gastrointestinal bleeding with digested blood.", category: "Medical Terminology", chapter: 18 },
  { question: "Which term describes vomiting blood?", options: ["Hematemesis", "Melena", "Hematuria", "Hematochezia"], answer: "Hematemesis", explanation: "Hematemesis is blood in vomit; melena is black tarry stool.", category: "Medical Terminology", chapter: 18 },
  { question: "A patient has right upper quadrant pain radiating to the shoulder after eating, with nausea. Which term best fits the likely organ system problem?", options: ["Cholecystitis", "Cystitis", "Appendicitis", "Esophagitis"], answer: "Cholecystitis", explanation: "Gallbladder inflammation commonly causes RUQ pain with referred shoulder pain.", category: "Common Abdominal Emergencies", chapter: 18 },
  { question: "Which finding is most associated with peritonitis?", options: ["Guarding and pain worsened by movement", "Painless urinary frequency only", "Brief wheeze after allergen exposure", "Pinpoint pupils with slow respirations"], answer: "Guarding and pain worsened by movement", explanation: "Peritoneal irritation often produces guarding, rigidity, and pain with movement.", category: "Acute Abdomen", chapter: 18 },
  { question: "Which term means blood in urine?", options: ["Hematuria", "Hematemesis", "Melena", "Polyuria"], answer: "Hematuria", explanation: "Hematuria is blood in urine and may occur with stones or urinary pathology.", category: "Urologic Emergencies", chapter: 18 },
  { question: "Which description best fits ileus in an acute abdomen?", options: ["Loss of normal intestinal movement", "Pain referred to a distant body area", "Excessive urinary output", "Tearing at the esophagus-stomach junction"], answer: "Loss of normal intestinal movement", explanation: "Ileus is paralysis or loss of normal bowel propulsion.", category: "Medical Terminology", chapter: 18 },

  { question: "What does polyuria mean?", options: ["Excessive urination", "Excessive thirst", "Excessive hunger", "Excessive sweating"], answer: "Excessive urination", explanation: "Polyuria is increased urination, often seen with hyperglycemia.", category: "Medical Terminology", chapter: 19 },
  { question: "Which term means excessive thirst?", options: ["Polydipsia", "Polyuria", "Polyphagia", "Diaphoresis"], answer: "Polydipsia", explanation: "Polydipsia is persistent excessive thirst.", category: "Medical Terminology", chapter: 19 },
  { question: "Which term means excessive hunger?", options: ["Polyphagia", "Polydipsia", "Polyuria", "Paresthesia"], answer: "Polyphagia", explanation: "Polyphagia means excessive hunger or increased food intake.", category: "Medical Terminology", chapter: 19 },
  { question: "Which presentation best fits Kussmaul respirations?", options: ["Deep, rapid breathing in metabolic acidosis", "Slow shallow breathing from opioid toxicity", "Noisy upper-airway obstruction", "Irregular gasping in cardiac arrest"], answer: "Deep, rapid breathing in metabolic acidosis", explanation: "Kussmaul respirations are a compensatory pattern often associated with DKA.", category: "DKA and Hyperglycemia", chapter: 19 },
  { question: "Which term describes ischemic pain from sickled red cells obstructing blood flow?", options: ["Vasoocclusive crisis", "Hyperosmolar syndrome", "Hemophilia A", "Thrombophilia"], answer: "Vasoocclusive crisis", explanation: "Sickle-shaped cells can block perfusion and cause severe pain.", category: "Sickle Cell Disease", chapter: 19 },
  { question: "Which term means an abnormal tendency to form clots?", options: ["Thrombophilia", "Hemophilia", "Hypoglycemia", "Polycythemia"], answer: "Thrombophilia", explanation: "Thrombophilia refers to increased tendency toward clot formation.", category: "Hematologic Assessment", chapter: 19 },

  { question: "What does urticaria mean?", options: ["Raised itchy hives", "Localized deep swelling", "Lower airway constriction", "Low blood pressure from shock"], answer: "Raised itchy hives", explanation: "Urticaria is hives, a common allergic skin finding.", category: "Medical Terminology", chapter: 20 },
  { question: "Which term means localized swelling often involving lips, face, tongue, or airway tissue?", options: ["Angioedema", "Urticaria", "Bronchospasm", "Rhinitis"], answer: "Angioedema", explanation: "Angioedema is deeper localized swelling and can threaten the airway.", category: "Medical Terminology", chapter: 20 },
  { question: "Which term describes narrowing of lower airways during anaphylaxis?", options: ["Bronchospasm", "Angioedema", "Vasodilation", "Urticaria"], answer: "Bronchospasm", explanation: "Bronchospasm narrows the bronchi and contributes to wheezing.", category: "Airway and Breathing", chapter: 20 },
  { question: "Which presentation best fits systemic anaphylaxis rather than isolated local reaction?", options: ["Hives with vomiting and hypotension after allergen exposure", "Pain and swelling limited to one sting site", "Itchy eyes during pollen exposure with normal perfusion", "Localized redness under a bandage"], answer: "Hives with vomiting and hypotension after allergen exposure", explanation: "Systemic involvement across skin, GI, and circulation is consistent with anaphylaxis.", category: "Anaphylaxis Recognition", chapter: 20 },
  { question: "Which medication is first-line for severe anaphylaxis in EMT care when indicated?", options: ["Epinephrine", "Diphenhydramine", "Albuterol only", "Activated charcoal"], answer: "Epinephrine", explanation: "Epinephrine rapidly treats bronchospasm and vasodilatory shock in anaphylaxis.", category: "Epinephrine", chapter: 20 },
  { question: "Which term best describes an allergic reaction affecting more than the exposure site?", options: ["Systemic reaction", "Local reaction", "Contact irritation", "Mechanical inflammation"], answer: "Systemic reaction", explanation: "Systemic reactions involve body systems beyond the local contact area.", category: "Medical Terminology", chapter: 20 },

  { question: "Which route of poisoning involves toxin entry through breathing?", options: ["Inhaled", "Ingested", "Injected", "Absorbed"], answer: "Inhaled", explanation: "Inhaled poisons enter through the respiratory tract.", category: "Medical Terminology", chapter: 21 },
  { question: "Which term best describes a poison entering through intact or damaged skin?", options: ["Absorbed poison", "Injected poison", "Ingested poison", "Inhaled poison"], answer: "Absorbed poison", explanation: "Absorbed poisons enter through skin or mucous membranes.", category: "Medical Terminology", chapter: 21 },
  { question: "Which medication reverses opioid-related respiratory depression?", options: ["Naloxone", "Epinephrine", "Atropine", "Activated charcoal"], answer: "Naloxone", explanation: "Naloxone is an opioid antagonist, but ventilation remains the immediate priority when breathing is inadequate.", category: "Opioids and Naloxone", chapter: 21 },
  { question: "Which toxidrome presents with hot dry skin, flushed appearance, delirium, and dilated pupils?", options: ["Anticholinergic", "Cholinergic", "Opioid", "Caustic ingestion"], answer: "Anticholinergic", explanation: "Anticholinergic poisoning commonly causes hot, dry, red, dilated, delirious findings.", category: "Anticholinergic Agents", chapter: 21 },
  { question: "Which toxidrome is suggested by salivation, lacrimation, urination, diarrhea, GI upset, emesis, and miosis?", options: ["Cholinergic", "Anticholinergic", "Sympathomimetic", "Sedative-hypnotic"], answer: "Cholinergic", explanation: "SLUDGE-type findings suggest cholinergic or organophosphate exposure.", category: "Cholinergic Agents", chapter: 21 },
  { question: "Which substance binds some swallowed toxins when permitted by protocol?", options: ["Activated charcoal", "Naloxone", "Oral glucose", "Aspirin"], answer: "Activated charcoal", explanation: "Activated charcoal can bind selected ingested toxins but is not appropriate for every patient or toxin.", category: "Activated Charcoal", chapter: 21 },

  { question: "Which term describes behavior or mental status change caused by physical brain or body dysfunction?", options: ["Organic brain syndrome", "Functional disorder", "Psychosis", "PTSD"], answer: "Organic brain syndrome", explanation: "Organic causes include medical, traumatic, toxicologic, metabolic, or neurologic problems.", category: "Medical Terminology", chapter: 22 },
  { question: "Which term means loss of contact with reality?", options: ["Psychosis", "Depression", "Anxiety", "Organic brain syndrome"], answer: "Psychosis", explanation: "Psychosis may involve delusions, hallucinations, or disorganized reality testing.", category: "Medical Terminology", chapter: 22 },
  { question: "Which condition combines agitation, disorientation, hallucinations or delusions, and serious physiologic stress?", options: ["Agitated delirium", "Simple panic reaction", "Dissociative amnesia", "Mild depression"], answer: "Agitated delirium", explanation: "Agitated delirium can be medically dangerous and requires safety, ABCs, and rapid transport.", category: "Agitated Delirium", chapter: 22 },
  { question: "Which term describes breathing impairment caused by body position or restraint limiting chest movement?", options: ["Positional asphyxia", "Bronchospasm", "Hyperventilation syndrome", "Kussmaul respiration"], answer: "Positional asphyxia", explanation: "Position or restraint can restrict ventilation and lead to sudden deterioration.", category: "Restraint Safety", chapter: 22 },
  { question: "Which question is most appropriate when suicide risk is possible?", options: ["Are you thinking about killing yourself?", "You are not serious about this, right?", "Can you promise this is only a joke?", "Would you rather talk about something else?"], answer: "Are you thinking about killing yourself?", explanation: "Direct suicide questioning is appropriate and does not create suicidal intent.", category: "Suicide Risk", chapter: 22 },
  { question: "Which care principle should come before physical restraint when feasible?", options: ["Verbal de-escalation", "Prone positioning", "Hobble restraint", "Silent observation from close range"], answer: "Verbal de-escalation", explanation: "Verbal de-escalation is safer when the scene allows and may prevent restraint-related harm.", category: "De-escalation", chapter: 22 },

  { question: "A patient describes sudden tearing abdominal pain radiating to the back with syncope and a pulsatile abdominal mass. Which condition is the highest-priority concern?", options: ["Abdominal aortic aneurysm", "Renal colic", "Biliary colic", "Gastroesophageal reflux"], answer: "Abdominal aortic aneurysm", explanation: "Tearing pain, syncope, shock signs, and pulsatile mass should raise concern for AAA until proven otherwise.", category: "Acute Abdomen", chapter: 18 },
  { question: "Which term means bright red blood passed from the rectum?", options: ["Hematochezia", "Hematemesis", "Melena", "Hematuria"], answer: "Hematochezia", explanation: "Hematochezia is bright red blood from the rectum, often suggesting lower GI bleeding or brisk upper GI bleeding.", category: "Medical Terminology", chapter: 18 },
  { question: "A patient with colicky flank pain radiating to the groin, nausea, and hematuria most likely has which urologic problem?", options: ["Renal colic from ureteral stone", "Cystitis limited to the bladder", "Peritonitis from bowel perforation", "Cholecystitis from gallbladder inflammation"], answer: "Renal colic from ureteral stone", explanation: "Stone pain is often severe, wave-like flank pain radiating to the groin and may include hematuria.", category: "Urologic Emergencies", chapter: 18 },
  { question: "Which finding best separates peritonitis from uncomplicated gastroenteritis during EMT assessment?", options: ["Rigid abdomen with involuntary guarding", "Nausea after eating", "Several episodes of diarrhea", "Mild diffuse abdominal cramping"], answer: "Rigid abdomen with involuntary guarding", explanation: "Rigidity and involuntary guarding suggest peritoneal irritation and a potentially surgical abdomen.", category: "Acute Abdomen", chapter: 18 },
  { question: "A patient with vomiting after heavy alcohol use develops severe upper abdominal pain radiating to the back. Which condition should remain high on the differential?", options: ["Pancreatitis", "Cystitis", "Diverticulitis", "Renal failure"], answer: "Pancreatitis", explanation: "Pancreatitis can present with severe epigastric pain radiating to the back, often with vomiting.", category: "Common Abdominal Emergencies", chapter: 18 },
  { question: "What does dysuria mean?", options: ["Painful or difficult urination", "Excessive urine production", "Blood in the urine", "Absence of urine output"], answer: "Painful or difficult urination", explanation: "Dysuria means painful or difficult urination and is common with urinary tract irritation or infection.", category: "Medical Terminology", chapter: 18 },
  { question: "Which abdominal pain pattern is most concerning for appendicitis progression?", options: ["Periumbilical pain migrating to the right lower quadrant", "Right upper quadrant pain after fatty foods", "Flank pain radiating to the groin", "Burning epigastric pain relieved by antacids"], answer: "Periumbilical pain migrating to the right lower quadrant", explanation: "Appendicitis often begins near the umbilicus and later localizes to the RLQ as peritoneal irritation develops.", category: "Common Abdominal Emergencies", chapter: 18 },
  { question: "A dialysis patient is weak with nausea, bradycardia, and wide-complex rhythm concerns after missing treatment. Which electrolyte problem should be suspected?", options: ["Hyperkalemia", "Hypocalcemia", "Hyponatremia", "Hypermagnesemia"], answer: "Hyperkalemia", explanation: "Missed dialysis can cause potassium accumulation, which may produce dangerous cardiac conduction changes.", category: "Renal Failure and Dialysis", chapter: 18 },

  { question: "A diabetic patient is confused, diaphoretic, and combative with a low glucose reading. Which process best explains the presentation?", options: ["Neuroglycopenia from inadequate glucose to the brain", "Osmotic diuresis from prolonged hyperglycemia", "Ketone buffering from metabolic acidosis", "Hemolysis from sickled erythrocytes"], answer: "Neuroglycopenia from inadequate glucose to the brain", explanation: "Low blood glucose deprives the brain of fuel, producing altered behavior, confusion, seizure, or coma.", category: "Hypoglycemia", chapter: 19 },
  { question: "Which phrase best defines diabetic ketoacidosis?", options: ["Insulin deficiency with hyperglycemia, dehydration, ketone production, and metabolic acidosis", "Sudden low glucose caused by excess insulin and missed meals", "Isolated allergic reaction to injected insulin", "Blood clot formation from abnormal hemoglobin shape"], answer: "Insulin deficiency with hyperglycemia, dehydration, ketone production, and metabolic acidosis", explanation: "DKA involves insufficient insulin, fat metabolism, ketone accumulation, dehydration, and acidosis.", category: "DKA and Hyperglycemia", chapter: 19 },
  { question: "Which finding set more strongly supports hyperglycemia with dehydration than isolated hypoglycemia?", options: ["Polyuria, polydipsia, warm dry skin, and gradual decline", "Diaphoresis, tremor, hunger, and rapid onset confusion", "Urticaria, wheezing, and hypotension after exposure", "Miosis, hypoventilation, and decreased responsiveness"], answer: "Polyuria, polydipsia, warm dry skin, and gradual decline", explanation: "Hyperglycemia commonly evolves gradually with osmotic diuresis, thirst, dehydration, and altered mentation.", category: "Hyperglycemia", chapter: 19 },
  { question: "What does hematemesis suggest when found in a patient with a hematologic disorder and shock signs?", options: ["Upper GI bleeding with possible major blood loss", "Blood in the urine from renal injury", "Clotting inside a deep leg vein", "Excess red cell destruction in the spleen"], answer: "Upper GI bleeding with possible major blood loss", explanation: "Hematemesis is vomiting blood and can represent serious upper GI hemorrhage, especially with shock signs.", category: "Hematologic Assessment", chapter: 19 },
  { question: "Which presentation best fits a hemophilia-related emergency?", options: ["Joint swelling and pain after minor trauma with prolonged bleeding risk", "Deep respirations with fruity breath and high glucose", "Sudden hives and wheezing after a sting", "Pinpoint pupils and respiratory depression"], answer: "Joint swelling and pain after minor trauma with prolonged bleeding risk", explanation: "Hemophilia impairs clotting and may cause prolonged bleeding or bleeding into joints after minor injury.", category: "Bleeding Disorders", chapter: 19 },
  { question: "Which statement best describes sickle cell crisis pain?", options: ["Tissue ischemia from obstructed microcirculation can cause severe pain without obvious trauma", "Pain occurs only when blood glucose is below normal", "Pain is caused by histamine release after allergen exposure", "Pain means the spleen is always ruptured"], answer: "Tissue ischemia from obstructed microcirculation can cause severe pain without obvious trauma", explanation: "Sickled cells can block small vessels, producing ischemic pain and possible organ complications.", category: "Sickle Cell Disease", chapter: 19 },
  { question: "Which term means abnormal sensation such as tingling or pins-and-needles?", options: ["Paresthesia", "Polyphagia", "Polydipsia", "Pallor"], answer: "Paresthesia", explanation: "Paresthesia means abnormal sensation and may occur in neurologic, endocrine, or perfusion-related problems.", category: "Medical Terminology", chapter: 19 },
  { question: "Which question best helps distinguish insulin-related hypoglycemia from DKA during history?", options: ["Did you take insulin or diabetes medication without eating?", "Have you had ankle swelling for several months?", "Did a family member recently have tuberculosis?", "Were you exposed to a new detergent?"], answer: "Did you take insulin or diabetes medication without eating?", explanation: "Medication timing, meals, and recent intake are key clues for hypoglycemia in a diabetic patient.", category: "Assessment and History", chapter: 19 },
  { question: "A patient with high glucose, hypotension, dry mucous membranes, and no significant ketone odor may fit which emergency more than classic DKA?", options: ["Hyperosmolar hyperglycemic state", "Acute hemophilia flare", "Anaphylactic shock", "Cholinergic poisoning"], answer: "Hyperosmolar hyperglycemic state", explanation: "HHS is severe hyperglycemia and dehydration, often without the marked ketoacidosis pattern of DKA.", category: "Hyperglycemia", chapter: 19 },
  { question: "Which EMT action is most appropriate for a conscious diabetic patient who can swallow and has suspected hypoglycemia?", options: ["Administer oral glucose per protocol", "Withhold glucose until hospital confirmation", "Give activated charcoal for sugar binding", "Assist with nitroglycerin for diaphoresis"], answer: "Administer oral glucose per protocol", explanation: "A conscious patient who can protect the airway may receive oral glucose according to local protocol.", category: "Hypoglycemia", chapter: 19 },

  { question: "Which physiologic effect makes epinephrine useful in anaphylactic shock?", options: ["Vasoconstriction plus bronchodilation", "Sedation plus respiratory depression", "Gastric toxin adsorption", "Platelet inhibition and anticoagulation"], answer: "Vasoconstriction plus bronchodilation", explanation: "Epinephrine supports blood pressure through vasoconstriction and improves airflow through bronchodilation.", category: "Epinephrine", chapter: 20 },
  { question: "Which finding suggests airway-threatening angioedema rather than uncomplicated urticaria?", options: ["Tongue swelling with voice change", "Itchy wheals on the forearms", "Localized redness around a sting site", "Watery eyes with normal speech"], answer: "Tongue swelling with voice change", explanation: "Tongue or upper-airway swelling with voice change can quickly threaten ventilation and oxygenation.", category: "Airway and Breathing", chapter: 20 },
  { question: "A patient has flushing, diffuse hives, abdominal cramping, and dizziness after eating shellfish. Which classification is most appropriate?", options: ["Systemic allergic reaction concerning for anaphylaxis", "Localized contact dermatitis only", "Isolated anxiety reaction without physiologic involvement", "Urologic emergency with referred pain"], answer: "Systemic allergic reaction concerning for anaphylaxis", explanation: "Skin, GI, and perfusion symptoms after allergen exposure suggest systemic anaphylaxis.", category: "Anaphylaxis Recognition", chapter: 20 },
  { question: "Which term best describes low blood pressure from widespread vessel dilation in anaphylaxis?", options: ["Distributive shock", "Obstructive shock", "Cardiogenic shock", "Neurogenic syncope only"], answer: "Distributive shock", explanation: "Anaphylaxis can cause distributive shock through vasodilation and capillary leakage.", category: "Shock", chapter: 20 },
  { question: "Why should a patient who improves after epinephrine still be transported and monitored?", options: ["Symptoms may recur or progress after temporary improvement", "Epinephrine permanently cures all allergic disease", "Transport is unnecessary unless hives remain visible", "Monitoring matters only when the patient loses pulses"], answer: "Symptoms may recur or progress after temporary improvement", explanation: "Anaphylaxis can recur after initial improvement, so reassessment and transport remain important.", category: "Patient Monitoring", chapter: 20 },
  { question: "Which term describes a severe, rapid systemic allergic reaction that can involve airway, breathing, and circulation?", options: ["Anaphylaxis", "Urticaria", "Rhinitis", "Contact dermatitis"], answer: "Anaphylaxis", explanation: "Anaphylaxis is a severe systemic hypersensitivity reaction involving multiple body systems.", category: "Medical Terminology", chapter: 20 },
  { question: "A patient has wheezing after a bee sting but no hives are visible. Which interpretation is safest?", options: ["Anaphylaxis can occur without every classic skin finding", "Anaphylaxis is impossible without hives", "Wheezing after a sting is always anxiety", "Only dermatologic findings guide epinephrine decisions"], answer: "Anaphylaxis can occur without every classic skin finding", explanation: "Respiratory or circulatory compromise after allergen exposure can indicate anaphylaxis even without obvious hives.", category: "Anaphylaxis Recognition", chapter: 20 },

  { question: "A patient is found with miosis, slow respirations, and cyanosis after using an unknown powder. Which immediate priority comes before medication response?", options: ["Ventilation and oxygenation support", "Activated charcoal administration", "Inducing vomiting", "Obtaining a full psychiatric history"], answer: "Ventilation and oxygenation support", explanation: "Opioid poisoning kills primarily through respiratory depression, so airway and ventilation are immediate priorities.", category: "Opioids and Naloxone", chapter: 21 },
  { question: "Which exposure history is most consistent with carbon monoxide poisoning?", options: ["Several occupants with headache and nausea in a heated home", "One patient with isolated hives after peanuts", "Flank pain after a long car ride", "Joint bleeding after minor knee impact"], answer: "Several occupants with headache and nausea in a heated home", explanation: "CO poisoning often affects multiple people in the same environment and causes vague neurologic or flu-like symptoms.", category: "Inhaled Poisons", chapter: 21 },
  { question: "Which toxidrome is most consistent with organophosphate exposure?", options: ["Bronchorrhea, bradycardia, miosis, diarrhea, and diaphoresis", "Dry skin, urinary retention, hyperthermia, and delirium", "Euphoria, hypertension, tachycardia, and dilated pupils", "Respiratory depression, miosis, and decreased bowel sounds"], answer: "Bronchorrhea, bradycardia, miosis, diarrhea, and diaphoresis", explanation: "Organophosphates produce cholinergic excess with wet secretions, miosis, GI effects, and possible respiratory failure.", category: "Cholinergic Agents", chapter: 21 },
  { question: "Which term describes the expected cluster of signs and symptoms from a particular poison class?", options: ["Toxidrome", "Prodrome", "Aura", "Syndesmosis"], answer: "Toxidrome", explanation: "A toxidrome is a recognizable poisoning pattern, such as opioid, cholinergic, or anticholinergic.", category: "Medical Terminology", chapter: 21 },
  { question: "Which ingestion is generally a contraindication concern for activated charcoal because of airway and tissue injury risk?", options: ["Caustic cleaner ingestion", "Standard-release acetaminophen ingestion with intact airway", "Selected medication overdose under protocol", "Recent ingestion with poison control approval"], answer: "Caustic cleaner ingestion", explanation: "Caustic ingestion can injure tissue and may increase aspiration or procedural risks; poison control and protocol guide care.", category: "Activated Charcoal", chapter: 21 },
  { question: "A patient has agitation, hypertension, tachycardia, diaphoresis, and dilated pupils after cocaine use. Which toxidrome is most likely?", options: ["Sympathomimetic", "Opioid", "Cholinergic", "Caustic"], answer: "Sympathomimetic", explanation: "Stimulants such as cocaine and methamphetamine commonly cause a sympathomimetic pattern.", category: "Stimulants", chapter: 21 },
  { question: "Which assessment detail most directly changes management in a poisoning call?", options: ["Substance, amount, route, time, and patient weight or size", "Patient shoe size and preferred hospital cafeteria", "Whether bystanders agree about the patient's personality", "Exact spelling of every medication before ABC assessment"], answer: "Substance, amount, route, time, and patient weight or size", explanation: "Poisoning management depends heavily on dose, route, timing, substance, and patient size while ABCs remain first.", category: "Poisoning Assessment", chapter: 21 },
  { question: "Which route creates the highest concern for hidden progressive tissue damage after a chemical spill?", options: ["Absorption through skin or mucous membranes", "Medication taken by mouth with known dose", "Known prescribed inhaler use", "Previous resolved food exposure"], answer: "Absorption through skin or mucous membranes", explanation: "Absorbed chemicals can continue damaging tissue until decontamination is performed safely.", category: "Absorbed Poisons", chapter: 21 },
  { question: "What does emesis mean in toxicology documentation?", options: ["Vomiting", "Excessive urination", "Loss of consciousness", "Pupil constriction"], answer: "Vomiting", explanation: "Emesis means vomiting and may be spontaneous or toxin-related; EMTs generally do not induce it.", category: "Medical Terminology", chapter: 21 },

  { question: "A patient with new paranoia also has hypoxia, fever, and an irregular pulse. Which approach is most appropriate?", options: ["Treat as possible medical delirium until life threats are assessed", "Assume primary psychosis because paranoia is present", "Delay vital signs until psychiatric transport arrives", "Focus only on law enforcement custody status"], answer: "Treat as possible medical delirium until life threats are assessed", explanation: "Medical causes of behavioral change must be considered, especially with abnormal vital signs.", category: "Medical Mimics", chapter: 22 },
  { question: "Which term best describes false fixed beliefs not explained by culture or reality?", options: ["Delusions", "Hallucinations", "Compulsions", "Flashbacks"], answer: "Delusions", explanation: "Delusions are fixed false beliefs; hallucinations are false sensory perceptions.", category: "Medical Terminology", chapter: 22 },
  { question: "Which term means perceiving something that is not actually present?", options: ["Hallucination", "Delusion", "Phobia", "Affect"], answer: "Hallucination", explanation: "Hallucinations are sensory perceptions without an external stimulus.", category: "Medical Terminology", chapter: 22 },
  { question: "A severely agitated patient is restrained prone and then becomes quiet. Which concern should immediately rise?", options: ["Ventilatory compromise from positional asphyxia", "Resolution of agitation proving no medical risk", "Improved oxygenation from reduced movement", "Need to delay reassessment until arrival"], answer: "Ventilatory compromise from positional asphyxia", explanation: "A quiet restrained patient may be deteriorating; prone restraint can impair ventilation and must be avoided or corrected per protocol.", category: "Restraint Safety", chapter: 22 },
  { question: "Which phrase best captures decisional capacity during refusal assessment?", options: ["Ability to understand, appreciate, reason about, and communicate a choice", "Being calm enough to speak politely", "Having any adult family member nearby", "Lacking a diagnosed psychiatric history"], answer: "Ability to understand, appreciate, reason about, and communicate a choice", explanation: "Capacity requires understanding relevant information, appreciating consequences, reasoning, and communicating a decision.", category: "Medical Legal", chapter: 22 },
  { question: "Which patient statement represents the highest immediate suicide risk?", options: ["I have the pills with me and I am going to take them when you leave", "Sometimes I feel sad but I have no plan", "I was angry earlier but called for help", "I missed work because I felt overwhelmed"], answer: "I have the pills with me and I am going to take them when you leave", explanation: "Specific plan, means, and stated intent indicate high immediate risk.", category: "Suicide Risk", chapter: 22 },
  { question: "Which environmental adjustment supports de-escalation on a behavioral emergency scene?", options: ["Reduce stimulation and keep a clear exit route", "Crowd the patient to prevent movement", "Speak over family members to establish control", "Stand between the patient and every visible exit"], answer: "Reduce stimulation and keep a clear exit route", explanation: "Lower stimulation, distance, exits, calm speech, and backup improve safety.", category: "De-escalation", chapter: 22 },
  { question: "Which medication or substance history can make a psychiatric presentation more likely to be toxicologic?", options: ["Recent stimulant use with hyperthermia and severe agitation", "Long-standing depression with normal vital signs", "Brief grief reaction after a known loss", "Stable anxiety with normal mentation"], answer: "Recent stimulant use with hyperthermia and severe agitation", explanation: "Stimulants can cause severe agitation, hyperthermia, tachycardia, and dangerous delirium.", category: "Medical Mimics", chapter: 22 },
  { question: "Which finding is most consistent with panic attack but still requires assessment for medical mimics?", options: ["Tingling, chest tightness, rapid breathing, and fear with preserved orientation", "Unilateral facial droop and aphasia", "Fever, stiff neck, and purpuric rash", "Hypotension with diffuse hives after allergen exposure"], answer: "Tingling, chest tightness, rapid breathing, and fear with preserved orientation", explanation: "Panic symptoms can resemble medical emergencies, so EMTs still assess ABCs, vitals, glucose when indicated, and history.", category: "Anxiety and Panic", chapter: 22 },
  { question: "Which documentation wording is most objective for a behavioral emergency?", options: ["Patient paced, clenched fists, shouted threats, and attempted to strike crew", "Patient was crazy and impossible to handle", "Patient seemed like a bad person", "Patient probably wanted attention"], answer: "Patient paced, clenched fists, shouted threats, and attempted to strike crew", explanation: "Objective behavior-based documentation is safer and more defensible than labels or judgments.", category: "Documentation", chapter: 22 },
  { question: "A patient alternates between extreme agitation and exhaustion with hot skin and incoherent speech after prolonged struggle. Which risk should be prioritized?", options: ["Excited or agitated delirium with medical collapse potential", "Simple refusal without medical concern", "Stable depression without physiologic stress", "Isolated malingering until proven otherwise"], answer: "Excited or agitated delirium with medical collapse potential", explanation: "Severe agitation with hyperthermia or exhaustion can precede sudden deterioration and requires rapid, coordinated care.", category: "Agitated Delirium", chapter: 22 }
];
...
questionBank.push(
  ...additionalAdvancedChapterQuestions.map((item) => ({
    chapter: item.chapter,
    topic: item.category,
    question: item.question,
    answers: item.options,
...
export {
  ...
  chapter21Questions,
  chapter22Questions,
  additionalAdvancedChapterQuestions
};
